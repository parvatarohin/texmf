...
\title{\textsc{Tiro Devanagari Sanskrit\\font specimen}}
\author{\relax}
\date{\relax}
...
\displayfonttable[%
  title-format=\multicolumn{17}{c}{\normalfont\bfseries Tiro Devanagari Sanskrit},
  title-format-cont=\multicolumn{17}{c}{\normalfont\bfseries Tiro Devanagari Sanskrit, \emph{cont.}},
  hex-digits=block,
  ...
  range-start=0000,
  range-end=FFFFF,
]{Tiro Devanagari Sanskrit}[Renderer=Harfbuzz]
