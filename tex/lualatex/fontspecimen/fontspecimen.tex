...
\title{\textsc{Libertinus Mono\\font specimen}}
\author{\relax}
\date{\relax}
...
\displayfonttable[%
  title-format=\multicolumn{17}{c}{\normalfont\bfseries Libertinus Mono},
  title-format-cont=\multicolumn{17}{c}{\normalfont\bfseries Libertinus Mono, \emph{cont.}},
  hex-digits=block,
  ...
  range-start=0000,
  range-end=FFFFF,
]{Libertinus Mono}[Renderer=Harfbuzz]
