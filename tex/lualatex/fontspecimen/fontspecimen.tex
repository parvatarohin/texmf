...
\title{\textsc{Libra Serif Modern\\font specimen}}
\author{\relax}
\date{\relax}
...
\displayfonttable[%
  title-format=\multicolumn{17}{c}{\normalfont\bfseries Libra Serif Modern},
  title-format-cont=\multicolumn{17}{c}{\normalfont\bfseries Libra Serif Modern, \emph{cont.}},
  hex-digits=block,
  ...
  range-start=0000,
  range-end=FFFFF,
]{Libra Serif Modern}[Renderer=Harfbuzz]
