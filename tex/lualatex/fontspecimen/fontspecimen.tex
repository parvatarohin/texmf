...
\title{\textsc{Libra Sans Modern\\font specimen}}
\author{\relax}
\date{\relax}
...
\displayfonttable[%
  title-format=\multicolumn{17}{c}{\normalfont\bfseries Libra Sans Modern},
  title-format-cont=\multicolumn{17}{c}{\normalfont\bfseries Libra Sans Modern, \emph{cont.}},
  hex-digits=block,
  ...
  range-start=0000,
  range-end=FFFFF,
]{Libra Sans Modern}[Renderer=Harfbuzz]
