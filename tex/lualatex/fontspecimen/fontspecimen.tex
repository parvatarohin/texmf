...
\title{\textsc{Linguistics Pro\\font specimen}}
\author{\relax}
\date{\relax}
...
\displayfonttable[%
  title-format=\multicolumn{17}{c}{\normalfont\bfseries Linguistics Pro},
  title-format-cont=\multicolumn{17}{c}{\normalfont\bfseries Linguistics Pro, \emph{cont.}},
  hex-digits=block,
  ...
  range-start=0000,
  range-end=FFFFF,
]{Linguistics Pro}[Renderer=Harfbuzz]
