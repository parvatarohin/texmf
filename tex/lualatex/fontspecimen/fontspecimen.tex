...
\title{\textsc{Libertinus Sans\\font specimen}}
\author{\relax}
\date{\relax}
...
\displayfonttable[%
  title-format=\multicolumn{17}{c}{\normalfont\bfseries Libertinus Sans},
  title-format-cont=\multicolumn{17}{c}{\normalfont\bfseries Libertinus Sans, \emph{cont.}},
  hex-digits=block,
  ...
  range-start=0000,
  range-end=FFFFF,
]{Libertinus Sans}[Renderer=Harfbuzz]
