...
\title{\textsc{New Computer Modern Devanagari\\font specimen}}
\author{\relax}
\date{\relax}
...
\displayfonttable[%
  title-format=\multicolumn{17}{c}{\normalfont\bfseries New Computer Modern Devanagari},
  title-format-cont=\multicolumn{17}{c}{\normalfont\bfseries New Computer Modern Devanagari, \emph{cont.}},
  hex-digits=block,
  ...
  range-start=0000,
  range-end=FFFFF,
]{NewComputerModern 10 Devanagari}[Renderer=Harfbuzz]
