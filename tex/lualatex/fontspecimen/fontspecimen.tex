...
\title{\textsc{Adobe Devanagari\\font specimen}}
\author{\relax}
\date{\relax}
...
\displayfonttable[%
  title-format=\multicolumn{17}{c}{\normalfont\bfseries Adobe Devanagari},
  title-format-cont=\multicolumn{17}{c}{\normalfont\bfseries Adobe Devanagari, \emph{cont.}},
  hex-digits=block,
  ...
  range-start=0000,
  range-end=FFFFF,
]{Adobe Devanagari}[Renderer=Harfbuzz]
