...
\title{\textsc{Literata TT Text\\font specimen}}
\author{\relax}
\date{\relax}
...
\displayfonttable[%
  title-format=\multicolumn{17}{c}{\normalfont\bfseries Literata TT Text},
  title-format-cont=\multicolumn{17}{c}{\normalfont\bfseries Literata TT Text, \emph{cont.}},
  hex-digits=block,
  ...
  range-start=0000,
  range-end=FFFFF,
]{Literata TT Text}[Renderer=Harfbuzz]
